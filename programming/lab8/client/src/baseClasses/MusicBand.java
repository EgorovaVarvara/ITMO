...
public class MusicBand implements Comparable<MusicBand>, Serializable {
     ...
     * @param user_login           login of user
     * @throws IllegalArgumentException if some fields are null or empty
     * @see Coordinates
     * @see MusicGenre
     * @see Label
     */
    public MusicBand(String name, Coordinates coordinates, int numberOfParticipants, MusicGenre musicGenre, Label label, String user_login) {
    ...
    public boolean equals(Object o) {
        ...
        return id == musicBand.id &&
                ...
                (coordinates.getX() != null ? coordinates.getX().equals(musicBand.getCoordinates().getX()) : musicBand.getCoordinates().getX() == null) &&
                (coordinates.getY() == musicBand.getCoordinates().getY()) &&
                (name != null ? name.equals(musicBand.getName()) : musicBand.getName() == null) &&
                (musicGenre != null ? musicGenre.equals(musicBand.getMusicGenre()) : musicBand.getMusicGenre() == null) &&
                (user_login != null ? user_login.equals(musicBand.getUser_login()) : musicBand.getUser_login() == null);
    }
