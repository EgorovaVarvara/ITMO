...
public class MusicBand implements Comparable<MusicBand>, Serializable {
    ...
    public MusicBand(int id, String name, Coordinates coordinates, LocalDateTime creationDate, int numberOfParticipants, MusicGenre musicGenre, Label label, String user_login){
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
