...
public class DataBaseManager {
    ...
    public static Connection connect(){
        try{
            ...
            return DriverManager.getConnection("jdbc:postgresql://localhost:8888/studs", "s408575", "");
    ...
    public Integer removeObject(int id, String user_login){
        try{
            Connection connection = connect();
...
//            PreparedStatement select = connection.prepareStatement(queryManager.selectObject);
            PreparedStatement select = connection.prepareStatement(queryManager.selectById);
            select.setInt(1, id);
