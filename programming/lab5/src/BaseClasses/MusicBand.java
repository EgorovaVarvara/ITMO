...
/**
 * The {@code MusicBand} class represents a music band, which includes its name,
 * coordinates, creation date, number of participants, music genre and label.
 *
...
public class MusicBand implements Comparable<MusicBand>, Serializable {
     ...
     */
    public MusicBand(String name, Coordinates coordinates, int numberOfParticipants, MusicGenre musicGenre,
            Label label) {
        if (name == null || name.isEmpty() || coordinates == null || numberOfParticipants <= 0 || musicGenre == null
                || label == null) {
    ...
    public boolean equals(MusicBand musicBand) {
        return (this.id == musicBand.getId()) || (this.name.equals(musicBand.getName())
                && this.coordinates.equals(musicBand.getCoordinates())
                && this.numberOfParticipants == musicBand.getNumberOfParticipants()
                && this.musicGenre.equals(musicBand.getMusicGenre()) && this.label.equals(musicBand.getLabel()));
